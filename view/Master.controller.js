...
sap.ui.core.mvc.Controller.extend("Z_UPDT_ZCFG_TEAM_REGION.view.Master", {
	...
	onSaveAll: function() {
		...
		oTable.getItems().forEach(function(row) {
			...
			if (this.gChangedRecordArr.indexOf(obj.TeamId) > -1) { //If record was changed
				//if (obj.InspId ) {
	...
	onFieldValueChange: function(oControlEvent) {
		...
		this.gChangedRecordArr.push(obj.TeamId);
